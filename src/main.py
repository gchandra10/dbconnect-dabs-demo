...
def main():
  ...
  print("Step 1 .....")
  table_name_bronze = "gannychan.mc_demo.taxi_demo_bronze"
  ...
  table_name_silver = "gannychan.mc_demo.taxi_demo_silver"
  ...
  print("Step 3 .....")
  yellow_view = "gannychan.mc_demo.taxi_demo_view_yellow"
  green_view = "gannychan.mc_demo.taxi_demo_view_green"
